...
<Tabs>
<Tab value="send-tokens" label="send-token-template">
...
<Tab value="gov" label="governance-template">
...
<Tab value="cosmwasm" label="cosmwasm-minimal">
...
<Tab value="ibc" label="ibc-transfer">
