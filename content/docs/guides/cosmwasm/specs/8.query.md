...
You can perform queries using an external client (such as an API or through the CLI) or within a contract. For more information on how this works, see [Querying contract state](/guides/cosmwasm/specs/8.query).
