...
The [IBC](/docs/) protocol provides a permissionless way for relaying data packets between blockchains, and combining IBC with CosmWasm enables powerful use cases, such as:
...
- Use the active channels listed in the [IBC channels](/docs/), or [run your own relayer](/docs/).
...
- [Active IBC channels](/docs/)

- [How to run your own relayer](/docs/)
