...
- Make sure your dapp is compatible with the new network. You can get details on any breaking changes in the [chain upgrades history](/guides/network/validators/6.chain-upgrades).
...
Code changes might be required when migrating your dApp to a new Terp Network network due to different factors. You can get details on any change that could have affected your dapp in the [chain upgrades history](/docs/).
...
Make sure to check our [guides](/docs/) for step-by-step instructions. Depending on if you needed to perform any changes to your smart contract code, you may need to re-build the project.
