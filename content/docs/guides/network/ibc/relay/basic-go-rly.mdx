...
<Tab value="release" label="release">
...
*Chains configuration will be pulled from chain-registry [https://github.com/cosmos/chain-registry](https://github.com/cosmos/chain-registry) so if you find misconfigurations (like gas fees or other) feel free to contribute.*
...
- [https://docs.junonetwork.io/validators/relaying](https://docs.junonetwork.io/validators/relaying)
