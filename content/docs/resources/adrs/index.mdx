...
Architectural Decision Records (ADRs) document the significant, irreversible, or structurally important decisions made in the Terp Network protocol and tooling ecosystem. Every ADR follows the standard template defined in ADR-1.
...
| 6 | [zk-wasm — Custom WASM Module for Authentication](/docs/resources/adrs/adr/6) | DRAFT | 2026-05 |
