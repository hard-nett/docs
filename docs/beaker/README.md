...
<p align="center" width="100%">
    <img  height="20" src="https://github.com/terpnetwork/beaker/actions/workflows/doctest.yml/badge.svg"/>
    <img height="20" src="https://github.com/terpnetwork/beaker/actions/workflows/lint.yml/badge.svg"/>
    <a href="https://github.com/terpnetwork/beaker/blob/main/LICENSE-APACHE"><img height="20" src="https://img.shields.io/badge/license-APACHE-blue.svg"/></a>
    <a href="https://github.com/terpnetwork/beaker/blob/main/LICENSE-MIT"><img height="20" src="https://img.shields.io/badge/license-MIT-blue.svg"/></a>
...
[Beaker](https://github.com/terpnetwork/beaker) makes it easy to scaffold a new cosmwasm app, with all of the dependencies for terp network hooked up, interactive console, and a sample front-end at the ready.
...
- [Deploy contract on localterp](#deploy-contract-on-localterp)
...
- [Docker](https://docs.docker.com/get-docker/) for running wasm `rust-optimizer` and spinning up [localterp](https://github.com/terpnetwork/localterp)
...
```sh
cargo install -f terp-beaker # `-f` flag for up-to-date version
```
...
# The list of all predefined accounts are here: https://github.com/terpnetwork/localterp#accounts
...
`account` contains [pre-defined accounts in localterp](https://github.com/terpnetwork/localterp#accounts).
...
- [Keplr chain setup for localterp](https://github.com/terpnetwork/localterp/tree/main/localKeplr)
- Add test account to Keplr
  ...
  - [List of test accounts and its mnemonics in localterp](https://github.com/terpnetwork/localterp#accounts)
