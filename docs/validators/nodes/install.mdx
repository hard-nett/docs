...
```bash
wget https://github.com/terpnetwork/terp-core/releases/download/v5.0.1/terpd_linux_amd64
```
</TabItem>
<TabItem value="arm64" label="arm64">

```bash
wget https://github.com/terpnetwork/terp-core/releases/download/v5.0.1/terpd_linux_arm64
```
</TabItem>
</Tabs>
</Container>
