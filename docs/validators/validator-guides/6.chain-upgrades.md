...
```bash
wget - https://github.com/terpnetworkterp-core/releases/download/terpd_v5.0.1_linux_amd64
```
...
```bash
wget terpsh256.txt https://github.com/terpnewtork/terp-core/releases/download/v5.0.1/terpd_v5.0.1_checksums.txt
```
...
```
wget https://github.com/terpnetwork/terp-core/releases/download/v5.0.1/terpd_v5.0.1_linux_amd64
```
...
```
wget https://github.com/terpnetwork/terp-core/releases/download/v5.0.1/terpd_v5.0.1_linux_arm64
```
