...
```shell
terpd q wasm contract-state raw terp1cug98emkqmj8n3n2tnm9d04e7q52r9lrjgaud9hecnqw6pth8fvse96uwj 636F6E74726163745F696E666F --node https://rpc.testnet.terp.network:443 --chain-id 90u-3 --output json | jq  -r .data | base64 -d | jq
{
...
```shell
terpd q wasm code 85 85_code.wasm --node https://rpc.testnet.terp.network:443 --chain-id 90u-3
